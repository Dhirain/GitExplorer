package com.dhirain.gitrepo.ui.history.adapter;
...
import com.dhirain.gitrepo.ui.history.view.TimeLineViewHolder;
import com.dhirain.gitrepo.utils.Constants;
import com.dhirain.gitrepo.utils.DateUtil;
...
public class TimeLineAdapter extends RecyclerView.Adapter<TimeLineViewHolder> {
    ...
    private void showCurrentItem(final TimeLineViewHolder holder, final HistoryModel musicModel, int pos) {
        ...
        } else if (musicModel.getContentType() == Constants.CONTENT_REPO) {
            drawableId = R.drawable.ic_branch;
        } else {
            drawableId = R.drawable.ic_contributor;
        }
